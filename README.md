...
"private cloud" using qemu-kvm, qemu-img, libvirt and libguestfs. Common distributions as Ubuntu 16, Debian 8, Centos6 and Centos 7 are supported and tested, and more flavours will be added later.
